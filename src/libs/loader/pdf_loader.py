...
class PdfLoader(BaseLoader):
    ...
    def _extract_and_process_images(
        ...
        try:
            ...
            for page_num in range(len(doc)):
                ...
                for img_index, img_info in enumerate(image_list):
                    try:
                        ...
                        images_metadata_list.append(image_metadata)
            ...
            if images_metadata_list:
                logger.info(f"Extracted {len(images_metadata_list)} images from {pdf_path}")
            else:
                logger.debug(f"No images found in {pdf_path}")
            
            return modified_text, images_metadata_list
