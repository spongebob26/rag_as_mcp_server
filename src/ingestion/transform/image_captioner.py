    ...
    def transform(
        ...
        for chunk in chunks:
            ...
            for img_id in referenced_ids:
                ...
                if caption:
                    captions.append({ img_id_stripped : caption})
            ...
            if captions:
                ...
                # captions is List[Dict[str, str]], merge into single Dict[str, str]
                for caption_dict in captions:
                    logger.info(caption_dict)
                    chunk.metadata["image_captions"].append(caption_dict)
                logger.info(chunk.metadata["image_captions"])
